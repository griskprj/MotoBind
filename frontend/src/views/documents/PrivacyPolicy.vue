          ...
          subsections: [
            {
              ...
              content: `
                <ul>
                  ...
                  <li>описание профиля (необязательно)</li>
                  <li>город/регион (необязательно)</li>
                  <li>опыт вождения (необязательно)</li>
            ...
            },
            {
              ...
              content: `
                ...
                <ul>
                  ...
                  <li>фото мотоцикла (необязательно)</li>
                </ul>
              `
            },
            {
            ...
            },
            {
              ...
              content: `
                ...
                <ul>
                  <li>публикации в социальной сети MotoSocial</li>
                  <li>мануалы;</li>
