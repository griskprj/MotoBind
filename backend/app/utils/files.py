...
def save_moto_photo(file, moto_id):
    ...
    compressed = compress_image(file, max_width=MAX_WIDTH, quality=WEBP_QUALITY, output_format="webp")
...
def save_user_avatar(file, user_id):
    ...
    compressed = compress_image(file, max_width=MAX_WIDTH_AVATAR, quality=WEBP_QUALITY, output_format="webp")
